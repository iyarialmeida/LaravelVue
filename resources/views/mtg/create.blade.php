              ...
              <div class="row">               
                ...
                <div class="col-3">   
                  <div class="form-group">                    
                    <select class="form-control " v-model="selectus" v-on="change:changeSelectus()">
        ...
        <div class="col-lg-5">
          <h4>MTG Sets</h4>
            <div class="container-fluid">
              <input class="form-control  shadow p-3 mb-5 bg-white rounded" type="text" placeholder="Filter Set-List" v-model="setQuery">
              <div class="list-group shadow p-3 mb-5 bg-white rounded scroller" role="tablist">
                <a 
                  ...
                  <div class="d-inline p-1"> @{{ set.name }}</div>
                  <div class="d-inline p-1 float-right"><img src="@{{ set.icon_svg_uri }}" height="30em" width="30em"></div>               
                </a>                
              </div>
            </div>
        </div>
            ...
            <div class="card shadow p-3 mb-5 bg-white rounded" style="width: 19rem;">
              ...
              <div class="card-footer">
                <div class="row">
                  ...
                  <div class="col-5">
                    Quantity
                    <input class="form-control  shadow p-3 mb-5 bg-white rounded"
                    id="numeric" 
                    type="number"  
